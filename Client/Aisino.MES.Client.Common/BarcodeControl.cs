...
namespace Aisino.MES.Client.Common
{
    public class BarcodeControl
    {
        ...
        private System.Windows.Forms.Control _MControl = null;
        ...
        public BarcodeControl(System.Windows.Forms.Control moveControl)
        {
            // 
            // TODO: 在此处添加构造函数逻辑 
            // 
        ...
        public delegate void ControlDeletingEventHandler(System.Windows.Forms.Control control);

        public event ControlDeletingEventHandler ControlDeleting = null;
        ...
        private void textBox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            if (e.KeyValue == 46)
            {
                if (ControlDeleting != null)
                {
                    ControlDeleting(_MControl);
                }
                for (int i = 0; i < 8; i++)
                {
        ...
        {
            _textbox.Focus();
            _MControl = (sender as System.Windows.Forms.Control);
            MoveHandles();
